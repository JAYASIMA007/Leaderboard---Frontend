          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mb-4 flex items-center">
              <input
                ...
                className="w-full sm:w-80 px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
              />
            </div>
            {tasks.length === 0 ? (
              ...
              <div className="space-y-4 sm:space-y-6">
                {filteredTasks.map((taskDocument) => (
                  <div
                                  ...
                                  {expandedTasks[task.task_id] && (
                                    <div className="p-3 sm:p-4 bg-white space-y-4 sm:space-y-6">
                                      <div>
                                        ...
                                        {task.subtasks.length === 0 && task.marking_criteria && (
                                          <div className="mt-6">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-3 sm:p-4 rounded-lg border border-emerald-200">
                                                ...
                                                <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                  {task.marking_criteria.fully_completed} Pts
                                                </p>
                                              </div>
                                              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-3 sm:p-4 rounded-lg border border-amber-200">
                                                ...
                                                <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                  {task.marking_criteria.partially_completed} Pts
                                                </p>
                                              </div>
                                              <div className="bg-gradient-to-br from-red-50 to-pink-50 p-3 sm:p-4 rounded-lg border border-red-200">
                                                ...
                                                <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                  {task.marking_criteria.incomplete} Pts
                                                </p>
                                              </div>
                                            </div>
                                          </div>
                                                    ...
                                                    <div className="ml-9 sm:ml-10">
                                                      ...
                                                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                                                        <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-3 sm:p-4 rounded-lg border border-emerald-200">
                                                          ...
                                                          <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                            {subtask.marking_criteria.fully_completed} Pts
                                                          </p>
                                                        </div>
                                                        <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-3 sm:p-4 rounded-lg border border-amber-200">
                                                          <div className="flex items-center mb-2">
                                                          ...
                                                          <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                            {subtask.marking_criteria.partially_completed} Pts
                                                          </p>
                                                        </div>
                                                        <div className="bg-gradient-to-br from-red-50 to-pink-50 p-3 sm:p-4 rounded-lg border border-red-200">
                                                          <div className="flex items-center mb-2">
                                                          ...
                                                          <p className="text-gray-700 font-bold text-lg sm:text-xl">
                                                            {subtask.marking_criteria.incomplete} Pts
                                                          </p>
                                                        </div>
                                                      </div>
                                                    </div>
