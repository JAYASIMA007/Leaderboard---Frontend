...
const SuperAdminLogin = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    setErrors({});
    try {
      const response = await fetch("http://13.54.119.187:8000/api/superadmin/login/", {
        method: "POST",
        headers: {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
          ...
          <p className="text-sm sm:text-base text-slate-600 mb-4">Redirecting to your dashboard...</p>
      ...
      <div className="relative bg-white shadow-lg rounded-2xl flex flex-col lg:flex-row max-w-6xl w-full overflow-hidden">
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col items-center justify-center p-6 sm:p-8 md:p-12 lg:p-20">
          <div className="w-full max-w-md flex flex-col items-center">
            ...
            <h1 className="text-sm sm:text-md font-medium text-center mb-2 text-[#fc0]">Login</h1>
            <h1 className="text-2xl sm:text-3xl font-medium text-center mb-2 text-[#111933]">Welcome Back!</h1>
